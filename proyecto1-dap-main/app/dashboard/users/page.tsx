...
const currentUser: User = {
  id: "usr_101",
  name: "Ana Martínez",
  role: "Administrador / UI Designer",
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 pt-1">
              {user.avatarUrl ? (
                ...
                <FontAwesomeIcon icon={faUserCircle} className="text-4xl text-white/80" />
              )}
              <div>
                ...
                <p className="text-indigo-100 text-xs font-medium flex items-center gap-1.5 mt-0.5">
                  <FontAwesomeIcon icon={faShieldHalved} className="text-indigo-200 text-[10px]" />
                  <span>{user.role}</span>
                </p>
              </div>
            </div>
